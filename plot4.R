...
plot(strptime(paste(data$Date,data$Time), format = "%d/%m/%Y %H:%M:%S"),as.numeric(data$Global_active_power),type="l", ylab="Golbal Actifve Power",xlab="")

plot(strptime(paste(data$Date,data$Time), format = "%d/%m/%Y %H:%M:%S"),as.numeric(data$Voltage),type="l", ylab="Voltage",xlab="datetime")
...
plot(strptime(paste(data$Date,data$Time), format = "%d/%m/%Y %H:%M:%S"),as.numeric(data$Global_reactive_power),type="l", ylab="Global_reactive_power",xlab="datetime")
